...
RUN DEBIAN_FRONTEND=noninteractive sudo apt-get -y install mysql-client mysql-server apache2 libapache2-mod-php7 pwgen python-setuptools vim-tiny php7-mysql  php5-ldap unzip
